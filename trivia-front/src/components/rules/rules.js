...
export default function Rules() {
  return (
      ...
      <div className="container1">
        ...
        <div id="lista">
          <ol>
            <li>Lee la pregunta y elige la respuesta que creas correcta de entre las 4 opciones.</li>
            <li>Tendrás un límite de tiempo de xx segundos.</li>
            <li>Si aciertas, sumas xx puntos.</li>
            <li>Si te equivocas, restas xx puntos.</li>
            <li>Deberás seguir respondiendo preguntas hasta que termine la partida.</li>
            <li>Al finalizar, podrás ver cuántos puntos obtuviste y elegir si quieres jugar de nuevo.</li>
